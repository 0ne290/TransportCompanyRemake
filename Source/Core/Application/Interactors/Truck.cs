...
public class Truck(IEntityStorageService<Domain.Entities.Driver> driverStorageService, IEntityStorageService<Domain.Entities.Branch> branchStorageService)
{
